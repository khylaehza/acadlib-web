...
const CusSearch = ({ curSearch, setCurSearch, label }) => {
	return (
		<div className='w-full block flex flex-row items-center border rounded-lg shadow-lg  focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm bg-gray-200 h-12'>
			<input
				type='text'
